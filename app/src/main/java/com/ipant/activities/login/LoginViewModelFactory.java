...
public class LoginViewModelFactory extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public LoginViewModelFactory(@NonNull Application application,RequestResultInterface requestResultInterface, NetworkConn.onRequestResponse onRequestResponse) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new LoginViewModel(application,requestResultInterface, onRequestResponse);
    }
}
