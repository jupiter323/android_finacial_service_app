...
public class WithdrawMoneyWebViewActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_withdraw_money_web_view);
...
//                    Toast.makeText(WithdrawMoneyWebViewActivity.this, "Din transaktion misslyckades!",
//                            Toast.LENGTH_LONG).show();

                    Intent intent = new Intent(WithdrawMoneyWebViewActivity.this, HomeActivity.class);
                    startActivity(intent);
                } else if(url.contains("success.html")){
//                    Toast.makeText(WithdrawMoneyWebViewActivity.this, "Transaktion har genomförts",
//                            Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(WithdrawMoneyWebViewActivity.this, HomeActivity.class);
                    startActivity(intent);
                }
        ...
        String url = "https://admin.ipant.se/paymentserver/example/www/withdraw.php?enduserid="+mobile_no+"&auth="+auth+"&appv="+appv+"&timezone="+timezone+"&lan="+lan+"&dev=android"+"&fcmt="+fcmt+"&email="+email;
        Log.d("sendurl:", url);
