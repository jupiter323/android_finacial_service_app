...
//                            Toast.LENGTH_LONG).show();
        ...
        String url = "https://admin.ipant.se/paymentserver/example/www/withdraw.php?enduserid="+mobile_no+"&auth="+auth+"&appv="+appv+"&timezone="+timezone+"&lan="+lan+"&dev=android"+"&fcmt="+fcmt;
        Log.d("sendurl:", url);
