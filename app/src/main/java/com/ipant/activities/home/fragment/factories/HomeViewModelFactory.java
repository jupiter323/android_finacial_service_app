...
public class HomeViewModelFactory extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public HomeViewModelFactory(@NonNull Application application, NetworkConn.onRequestResponse onRequestResponse) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new HomeViewModel(application, onRequestResponse);
    }
}
