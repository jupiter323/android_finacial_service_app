...
public class ContactUsViewModelFactory extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public ContactUsViewModelFactory(@NonNull Application application, NetworkConn.onRequestResponse onRequestResponse) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new ContactUsViewModel(application, onRequestResponse);
    }
}
